    ...
    internal static int Main(string[] args)
    {
        ...
        try
        {
            ...
            exitCode = command switch
            {
                ...
                // "scan" => DISABLED (Vision support removed for public release)
                ...
                // "snapshot" => DISABLED (Vision support removed for public release)
                "readiness" => ReadinessCommand(restArgs),
                "uia-test" => UiaTestCommand(restArgs),
                // "form-dump" => DISABLED (Vision support removed for public release)
                "toolbar-ocr" => ToolbarOcrCommand(restArgs),
                "titlebar" => TitlebarCommand(restArgs),
                "validate" => ValidateCommand(restArgs),
                // "chart-analyze" => DISABLED (Vision support removed for public release)
                "hts-stress" => HtsStressCommand(restArgs),
                // "tooltip-probe" => DISABLED (Vision support removed for public release)
