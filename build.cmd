...
if exist "%BIN_DIR%\wkappbot.exe" (
  ...
  set "AI_PROMPT=WKAppBot just built successfully. The user's terminal code page is !CODEPAGE!. Respond in the natural language that matches this code page. You are a thoughtful WKAppBot guide. Open with 2-3 warm sentences about what it means to live alongside AI in this era -- that tools like this are the bridge where AI stops just thinking and starts actually helping humans do things. Then: (1) explain what WKAppBot is in that spirit, (2) show 5 things to try RIGHT NOW with exact commands (note: 'wkappbot windows' with no args filters by wkappbot keyword; use 'wkappbot windows *' for all), (3) introduce the Skill system -- 'wkappbot skill list' is accumulated human-AI knowhow that grows over time, (4) mention the Suggest system -- 'wkappbot suggest' lets anyone queue a bug or idea mid-task, this is how the WKAppBot world gets built together by its users and AI alike, (5) close with one warm sentence about the shared journey ahead. Warm, clear, inspiring."
  echo.
  echo ============================================================
