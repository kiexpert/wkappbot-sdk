...
- [x] nightly-heal 2026-05-26: skill audit + repo-health LITE (SECURITY 7.4.x, AGENTS/CLAUDE parity OK) + Pending dedupe done- [x] cdp open Chrome multiplication: FindRunningChromePortAny port-file guard fixed (registered>0 condition) -- Core pending build+commit
